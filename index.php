      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            $start = $experience[$j]['start'];
            $end = $experience[$j]['end'];
            ?>
            <h5 class="w3-opacity"><b><?php echo $experience[$j]['work']; ?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $start?> - <?= $end?></h6>
				<p><?php echo $experience[$j]['text']; ?></p>
            <hr>
            <?php endfor;?>
            <br>
...
<!-- https://paiza.io/projects/jxScqlGiPKYEekl4dFmVgw?language=php -->